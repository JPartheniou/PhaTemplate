...
<?php printf( __( '</div></div><div class="site-footer-bottom-bar"><div class="site-container"><div class="site-footer-bottom-bar-left"> %1$s %2$s', 'topshop' ), 'Copyright © 2015 TenMakeOne.', '</div><div class="site-footer-bottom-bar-right">' ); ?>
