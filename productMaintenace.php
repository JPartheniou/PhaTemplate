...
<tr class="active">
    <td>Product Type: </td>
    <td><input type="text" name="Type1" size="50" />  Or Select an existing Type 
        <?php 
...
<tr class="active">
     <td>Description: </td>
     <td><textarea name="Description" cols="51" rows="10" required="required"></textarea></td>
</tr>	
<tr class="active">
     <td>Short Description: </td>
     <td><textarea name="ShortDesc" cols="51" rows="10" required="required"></textarea></td>
</tr>	
<tr class="active">
    <td>Product Image: </td>	
